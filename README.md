...
导师原始计划要求所有实验尽量使用 Jupyter Notebook 完成并通过 GitHub 更新进度。这个仓库不是替代个人每周交付物，而是用于小组互相阅读、复用和讨论的公共 Notebook 资源库。

后续 Week 4-8 的论文汇报、LaTeX 报告、baseline 复现和最终成果仍按个人周计划仓库或导师指定位置提交。
